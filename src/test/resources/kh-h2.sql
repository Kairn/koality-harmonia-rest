...
INSERT INTO MOMENT (MOMENT_ID, POST_DATE, POST_COMMENT, KOALIBEE_ID)
VALUES (NEXTVAL('SEQ_MOMENT_ID'), PARSEDATETIME('2019-01-16', 'YYYY-MM-DD'), 'I love tianshi dongman', 1);
INSERT INTO MOMENT (MOMENT_ID, POST_DATE, POST_COMMENT, KOALIBEE_ID)
VALUES (NEXTVAL('SEQ_MOMENT_ID'), PARSEDATETIME('2017-06-05', 'YYYY-MM-DD'), 'Nothing I want to say', 1);
INSERT INTO MOMENT (MOMENT_ID, POST_DATE, POST_COMMENT, KOALIBEE_ID)
VALUES (NEXTVAL('SEQ_MOMENT_ID'), PARSEDATETIME('2019-02-24', 'YYYY-MM-DD'), 'man, JavaScript is garbage', 1);
INSERT INTO MOMENT (MOMENT_ID, POST_DATE, POST_COMMENT, KOALIBEE_ID)
